...
def func(message):
    ...
    if text == "Общее описание программы «Филология»":
        ...
        bot.send_photo(message.chat.id, photo=open(IMG_VYPUSKNIKI, "rb"))
        ...
        bot.send_photo(message.chat.id, photo=open(IMG_SITE_OP, "rb"))
        ...
        bot.send_photo(message.chat.id, photo=open(IMG_INFORMAL, "rb"))
